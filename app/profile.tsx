    ...
    <View className="flex-1 bg-[#010302]">
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <Text style={{ fontFamily: "RoyalBold" }} className="text-white text-2xl mt-4">
        ...
        <View className="px-6 mb-10">
          <Text className="text-white/40 text-xs uppercase tracking-widest mb-4 ml-2">Account Settings</Text>
          ...
          >
            ...
            <Text className="text-[#ff4444] text-base ml-4 font-bold">Logout</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
        ...
        <View className="flex-1 justify-end bg-black/80">
          <View className="bg-[#0B2B1F] rounded-t-[40px] p-8 border-t border-[#C5A059]/30">
            <View className="flex-row justify-between items-center mb-6">
              <View>
                <Text className="text-white/60 text-xs uppercase tracking-widest">Connect with us</Text>
                <Text
            ...
            <View className="space-y-4">
                <TouchableOpacity className="flex-row items-center bg-black/20 p-5 rounded-2xl border border-[#C5A059]/10 mb-3">
                    ...
                    <View className="ml-4">
                        <Text className="text-white/40 text-[10px] uppercase font-bold">Email Us</Text>
                        <Text className="text-white text-base">support@eternalpartner.com</Text>
                    </View>
                </TouchableOpacity>
                ...
                <TouchableOpacity className="flex-row items-center bg-black/20 p-5 rounded-2xl border border-[#C5A059]/10 mb-3">
                    ...
                    <View className="ml-4">
                        <Text className="text-white/40 text-[10px] uppercase font-bold">Call Us</Text>
                ...
                <TouchableOpacity className="flex-row items-center bg-black/20 p-5 rounded-2xl border border-[#C5A059]/10">
                    <View className="bg-[#C5A059]/10 p-3 rounded-xl">
                        <Ionicons name="chatbubbles-outline" size={24} color="#C5A059" />
                    </View>
                    <View className="ml-4">
                        <Text className="text-white/40 text-[10px] uppercase font-bold">Live Chat</Text>
                        <Text className="text-white text-base">Start a conversation</Text>
                    </View>
                </TouchableOpacity>
            </View>
